...
for K in tqdm(range(30)):
    ...
    res[K]=return_scores_aggregated(SCORE_simple,EXPECTED,intercept = 1)
...
SCORE_simple = simple_score(adj0,features01,SP)
#%%
plot_score(SCORE_simple,POS,NEG,ZERO,HSIC = [1,5],title="Simple",fontsize=20)
...
for K in tqdm(range(30)):
    ...
    EXPECTED[:,7+nb_groupe]= -signe3
    EXPECTED[:,8+nb_groupe]= -signe4
    RES[K] = return_scores_aggregated(SCORE_simple,EXPECTED,intercept = 1+ nb_groupe)
